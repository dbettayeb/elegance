...
import { buildEndDate, toLocalTimeInput } from '@/lib/event-time'
...
export default function EditWeddingForm({ wedding }: { wedding: Wedding }) {
  ...
  const [form, setForm] = useState({
    ...
    bride_family_ar: wedding.bride_family_ar ?? '',
    groom_family_ar: wedding.groom_family_ar ?? '',
    bride_family_prefix_ar: wedding.bride_family_prefix_ar ?? '',
    groom_family_prefix_ar: wedding.groom_family_prefix_ar ?? '',
    families_intro_ar: wedding.families_intro_ar ?? '',
    couple_email: wedding.couple_email,
    event_date: dateStr,
    event_time: timeStr,
    event_end_time: toLocalTimeInput(wedding.event_end_date),
    ...
    guestbook_private: wedding.guestbook_private ?? false,
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Bascule au lendemain décidée en heure locale (voir buildEndDate).
