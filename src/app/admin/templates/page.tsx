      ...
      <div className="admin-page-header">
        <div>
          ...
          <p className="admin-page-subtitle">
            {TEMPLATES.length} designs disponibles. Cliquez sur un template pour voir un aperçu réel.
          </p>
        </div>
...
function TemplateCard({ template }: { template: typeof TEMPLATES[number] }) {
  ...
  return (
    ...
    >
      ...
      onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--admin-text)'; e.currentTarget.style.transform = 'translateY(-2px)' }}
      ...
      >
        ...
        <div style={{
          ...
          {/* Nom stylé du template (utilise les couleurs de la palette) */}
          <div style={{
            textAlign: 'center',
            padding: '0 20px',
          }}>
