...
export async function PATCH(
  ...
  try {
    ...
    const {
      ...
      custom_font, custom_font_size, ar_font_theme, max_guests,
      program,
      show_rsvp, show_guestbook, guestbook_private, show_countdown, show_program, moderation_on,
    ...
    const { error } = await supabase
      ...
      .update({
        ...
        custom_font_size: custom_font_size ?? 100,
        max_guests: max_guests ?? null,
        ar_font_theme:    ar_font_theme    || 'classic',
        show_rsvp:         show_rsvp         ?? true,
        show_guestbook,
        guestbook_private: guestbook_private ?? false,
